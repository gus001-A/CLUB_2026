                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea v-model="form.descripcion" rows="3" placeholder="Describe el evento..."
                                class="admin-input px-3 py-2.5 resize-none"></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p v-if="form.errors.fecha" class="text-red-600 text-xs mt-1">{{ form.errors.fecha }}
                                </p>
                            </div>
                            <div>
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="form.ciudad" type="text" placeholder="Ej. Ciudad de México"
                                    class="admin-input px-3 py-2.5" />
                                <p v-if="form.errors.ciudad" class="text-red-600 text-xs mt-1">{{ form.errors.ciudad }}
                                </p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1.5">Zona / lugar
                                    exacto</label>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="form.ubicacion_lat" type="number" step="0.00000001"
                                    placeholder="Ej. 19.4326" class="admin-input px-3 py-2.5" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1.5">Longitud
                                    (opcional)</label>
                                <input v-model="form.ubicacion_lng" type="number" step="0.00000001"
                                    placeholder="Ej. -99.1332" class="admin-input px-3 py-2.5" />
                            </div>
                        </div>
                        <p class="text-xs text-gray-400">Para ubicar el evento en un mapa. Puedes dejarlo en blanco por
                            ahora.
                        </p>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input v-model="form.capacidad" type="number" min="1" placeholder="Ilimitado"
                                class="admin-input px-3 py-2.5" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 mt-1">Cambia a "Completado" manualmente cuando el evento
                                termine.
                            </p>
                        </div>
                        <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <label
                                    class="admin-input px-3 py-2.5 flex items-center gap-2 cursor-pointer text-gray-500 hover:border-brand transition flex-1">
