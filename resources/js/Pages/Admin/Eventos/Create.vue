...
<template>
    ...
    <AdminLayout>
        ...
        <template #breadcrumb>Dashboard / Eventos / Nuevo</template>
            ...
            <div class="admin-prod-form-grid">
                ...
                <div class="admin-prod-form">
                    <div class="admin-prod-form-header">
                        ...
                        <div>
                            <h1>Nuevo Evento</h1>
                            <p>Ingresa los datos del evento</p>
                        </div>
                    </div>
                ...
                <div class="admin-prod-sidebar">
                    ...
                    <div class="admin-prod-sidebar-card">
                        <div class="admin-prod-sidebar-card__header">
                            ...
                            <span class="admin-prod-count">{{ preview ? 1 : 0 }}/1</span>
                        </div>
                        <div class="admin-prod-sidebar-card__body">
                            <label v-if="!preview" class="admin-prod-upload-area">
                    ...
                    <div class="admin-prod-action-card">
                        ...
                        <Link :href="route('admin.eventos.index')" class="admin-prod-btn-cancel">
                            Cancelar
                        </Link>
                    </div>
                </div>
