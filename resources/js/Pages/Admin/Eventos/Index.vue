                    ...
                    <div class="flex flex-col flex-1 min-w-0">
                        ...
                        <div class="px-6 pt-6">
                            <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
                                ...
                                <Link :href="route('admin.eventos.create')" class="admin-btn-primary bg-red-600 hover:bg-red-700 whitespace-nowrap">
                            ...
                            <div class="flex flex-wrap lg:flex-nowrap items-center gap-3 py-3">
                                <div class="relative flex-1 min-w-[180px]">
                                    ...
                                    <input v-model="q" type="text" placeholder="Buscar evento..." class="admin-input pl-10 py-2.5 focus:border-red-500 focus:ring-red-500" />
                                </div>
                                <div class="w-full sm:w-auto min-w-[150px]">
                                    <select v-model="estado" class="admin-input py-2.5 focus:border-red-500 focus:ring-red-500">
                                ...
                                <div class="w-full sm:w-auto min-w-[150px]">
                                    <select v-model="tipo" class="admin-input py-2.5 focus:border-red-500 focus:ring-red-500">
                ...
                <div class="w-full lg:flex-[39] min-w-0 admin-card p-6 flex flex-col justify-between">
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-4 pt-3 border-t border-gray-100">
                        <div class="flex items-center gap-2.5 bg-gray-50/50 p-2.5 rounded-xl">
                            <div class="admin-icon-circle bg-red-50 text-red-600" style="width:32px;height:32px"><i class="pi pi-users text-xs"></i></div>
                            <div>
                        ...
                        <div class="flex items-center gap-2.5 bg-gray-50/50 p-2.5 rounded-xl">
                            <div class="admin-icon-circle bg-red-50 text-red-600" style="width:32px;height:32px"><i class="pi pi-star text-xs"></i></div>
                            <div>
                    ...
                    <div>
                        ...
                        <div class="space-y-2.5">
                            <Link :href="route('admin.eventos.create')" class="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 transition group">
                                <div class="admin-icon-circle bg-red-50 text-red-600" style="width:40px;height:40px"><i class="pi pi-calendar-plus text-xs"></i></div>
                                <div>
                                    <p class="text-xs font-bold text-gray-800">Crear Evento</p>
                                    <p class="text-[10px] text-gray-400">Organiza un nuevo evento</p>
                                </div>
                            </Link>
                            <div class="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 transition group cursor-pointer">
                                <div class="admin-icon-circle bg-red-50 text-red-600" style="width:40px;height:40px"><i class="pi pi-file text-xs"></i></div>
                                <div>
                            ...
                            <div class="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 transition group cursor-pointer">
                                <div class="admin-icon-circle bg-red-50 text-red-600" style="width:40px;height:40px"><i class="pi pi-folder text-xs"></i></div>
                                <div>
                            ...
                            <div class="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 transition group cursor-pointer">
                                <div class="admin-icon-circle bg-red-50 text-red-600" style="width:40px;height:40px"><i class="pi pi-cog text-xs"></i></div>
                                <div>
