        ...
        <div class="w-full max-w-[1920px] mx-auto px-2 sm:px-4">
            ...
            <div class="relative bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-6">
                ...
                <div class="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div class="flex items-center gap-4">
                        <div class="rounded-2xl bg-red-50 text-red-600 flex items-center justify-center shrink-0" style="width:64px;height:64px">
            ...
            <div class="flex flex-col lg:flex-row gap-6 items-start w-full">
                ...
                <div class="w-full lg:w-2/3 flex flex-col gap-6">
                    ...
                    <!-- Descripción -->
                    <div v-if="evento.descripcion" class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                        <h2 class="text-sm font-bold text-gray-900 mb-2 flex items-center gap-2">
                            <i class="pi pi-align-left text-red-600 text-xs"></i> Descripción
                        </h2>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="flex items-center gap-3 bg-gray-50/60 rounded-xl p-3">
                                <div style="width:40px;height:40px;flex:none;display:flex;align-items:center;justify-content:center" class="rounded-lg bg-red-50 text-red-600"><i class="pi pi-calendar text-sm"></i></div>
                                <div>
                                    <p class="text-[11px] text-gray-400 uppercase font-medium">Fecha</p>
                                    <p class="text-sm font-semibold text-gray-800">{{ formatFecha(evento.fecha) }}</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-3 bg-gray-50/60 rounded-xl p-3">
                                <div class="w-10 h-10 rounded-lg bg-red-50 text-red-600 flex items-center justify-center shrink-0"><i class="pi pi-clock text-sm"></i></div>
                                <div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-50/60 rounded-xl p-3">
                                <div class="w-10 h-10 rounded-lg bg-red-50 text-red-600 flex items-center justify-center shrink-0"><i class="pi pi-map-marker text-sm"></i></div>
                                <div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-50/60 rounded-xl p-3">
                                <div class="w-10 h-10 rounded-lg bg-red-50 text-red-600 flex items-center justify-center shrink-0"><i class="pi pi-map text-sm"></i></div>
                                <div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-50/60 rounded-xl p-3">
                                <div class="w-10 h-10 rounded-lg bg-red-50 text-red-600 flex items-center justify-center shrink-0"><i class="pi pi-ticket text-sm"></i></div>
                                <div>
                            ...
                            <div class="flex items-center gap-3 bg-gray-50/60 rounded-xl p-3">
                                <div class="w-10 h-10 rounded-lg bg-red-50 text-red-600 flex items-center justify-center shrink-0"><i class="pi pi-users text-sm"></i></div>
                                <div>
                            ...
                            <div v-if="evento.codigo_vestimenta" class="flex items-center gap-3 bg-gray-50/60 rounded-xl p-3 sm:col-span-2">
                                <div class="w-10 h-10 rounded-lg bg-red-50 text-red-600 flex items-center justify-center shrink-0"><i class="pi pi-star text-sm"></i></div>
                                <div>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                        ...
                        <div class="flex flex-col gap-2.5">
                            <Link :href="route('admin.eventos.edit', evento.id)"
                                class="bg-red-600 hover:bg-red-700 text-white font-medium px-4 py-2.5 rounded-xl text-sm flex items-center justify-center gap-2 shadow-sm">
                                <i class="pi pi-pencil text-xs"></i> Editar evento
                            </Link>
                            <button @click="eliminar"
                                class="border border-red-200 text-red-600 hover:bg-red-50 font-medium px-4 py-2.5 rounded-xl text-sm flex items-center justify-center gap-2">
