...
<template>
    ...
    <AdminLayout>
        ...
        <div class="w-full max-w-[1920px] mx-auto px-2 sm:px-4">
            ...
            <!-- Fila 2: Gestión + Enlaces (2/3) | Acciones Rápidas + Resumen (1/3) -->
            <div class="flex flex-col lg:flex-row gap-6 w-full items-stretch">
                ...
                <div class="w-full lg:w-2/3 flex flex-col gap-6">
                    ...
                    <div id="enlaces" class="bg-white rounded-2xl border border-gray-200/80 shadow-sm px-6 py-6 flex-1 flex flex-col justify-between">
                        <div>
