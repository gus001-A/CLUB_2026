    ...
    <AdminLayout>
        ...
        <div class="w-full max-w-[1920px] mx-auto px-2 sm:px-4">
            ...
            <div class="flex flex-col lg:flex-row gap-6 items-start w-full">
                ...
                <!-- Columna izquierda: detalle de la transacción -->
                <div class="w-full lg:flex-[2] min-w-0 admin-card p-6">
                ...
                <!-- Columna derecha: usuario, creador, acciones -->
                <div class="w-full lg:flex-1 min-w-0 flex flex-col gap-6">

                    <!-- Usuario -->
                    <div class="admin-card p-6">
                        <h3 class="text-sm font-semibold text-gray-900 mb-4">Usuario</h3>
                    ...
                    <!-- Creador (si aplica) -->
                    <div v-if="transaccion.creador" class="admin-card p-6">
                        <h3 class="text-sm font-semibold text-gray-900 mb-4">Creador</h3>
