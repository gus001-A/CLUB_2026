...
<template>
    ...
    <AdminLayout>
        ...
        <div class="w-full max-w-[1920px] mx-auto px-2 sm:px-4">
            ...
            <div class="flex flex-col lg:flex-row gap-6 mb-6 w-full">
                ...
                <div class="w-full lg:w-1/4">
                    <KpiCard
                        ...
                        :value="money(stats?.ingresosTotales ?? 0)"
                        icon="pi-dollar"
                        hint="Sin movimientos recientes"
                        hint-color="text-gray-400"
                    />
                </div>
                <div class="w-full lg:w-1/4">
                    <KpiCard
                        label="Suscripciones Activas"
                        :value="stats?.suscripcionesActivas ?? 0"
                        icon="pi-crown"
                ...
                <div class="w-full lg:w-1/4">
                    <KpiCard
                        ...
                        :value="money(stats?.ventasShop ?? 0)"
            ...
            <!-- Fila 2: Gestión de Usuarios (3/4) + Acciones Rápidas (1/4) -->
            <div class="flex flex-col lg:flex-row gap-6 mb-6 w-full items-stretch">
                ...
                <!-- Acciones Rápidas -->
                <div class="w-full lg:w-1/4 admin-card p-4 flex flex-col justify-between">
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900 mb-4">Acciones Rápidas</h2>
                        <div class="space-y-3">
                            <Link :href="route('admin.usuarios.index')" class="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:bg-gray-50 transition group">
                                <div class="admin-icon-circle bg-red-50" style="width:44px;height:44px">
                            ...
                            <Link :href="route('admin.cobros.index')" class="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:bg-gray-50 transition group">
                                <div class="admin-icon-circle bg-red-50" style="width:44px;height:44px">
                            ...
                            <Link :href="route('admin.eventos.create')" class="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:bg-gray-50 transition group">
                                <div class="admin-icon-circle bg-red-50" style="width:44px;height:44px">
                            ...
                            <Link :href="route('admin.invitaciones.create')" class="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:bg-gray-50 transition group">
                                <div class="admin-icon-circle bg-red-50" style="width:44px;height:44px">
            ...
            <div class="flex flex-col lg:flex-row gap-6 mt-6 w-full">
                ...
                <!-- 1. Cobros Recientes -->
                <div class="w-full lg:w-1/3 admin-card p-6 flex flex-col justify-between">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div v-for="e in (eventosProximos || [])" :key="e.id" class="flex items-center justify-between p-2 rounded-xl hover:bg-gray-50 transition">
                                <div class="flex items-center gap-3 min-w-0">
                                    <div class="w-10 h-10 min-w-[40px] max-w-[40px] min-h-[40px] max-h-[40px] rounded-xl overflow-hidden shrink-0 bg-gray-100 flex items-center justify-center border border-gray-100">
